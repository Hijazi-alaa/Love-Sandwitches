...
def get_sales_data():
    ...
    via the terminal, wish must be a string of 6 numbers seperated by commas.
...
def validate_data(values):
    """
    Insinde the try, vonverts all strting values into integers.
...
def calculate_stock_data(data):
    """
    Calculate the avarage sock for each item type, adding 10%
    """
